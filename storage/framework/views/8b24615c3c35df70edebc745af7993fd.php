...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('clients.dashboard')); ?>" class="bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-4 rounded-lg transition flex items-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr class="hover:bg-primary-50">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            <?php echo e($client->type_client == 'particulier' ? 'bg-primary-100 text-primary-800' : ''); ?>
                    ...
                    <td class="px-6 py-4 text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('clients.show', $client)); ?>" class="p-2 rounded-lg bg-primary-100 hover:bg-primary-200 text-primary-600 transition" title="Voir">
