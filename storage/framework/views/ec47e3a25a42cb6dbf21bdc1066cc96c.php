...
521;Banques locales;compte;debit;;;banque;;Comptes bancaires locaux;521
    ...
    <!-- Formulaire d'import -->
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="<?php echo e(route('accounting.chart-of-accounts.import')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\accounting\chart-of-accounts\import.blade.php ENDPATH**/ ?>