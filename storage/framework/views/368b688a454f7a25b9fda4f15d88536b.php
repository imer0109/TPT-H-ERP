...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="<?php echo e(route('hr.employees.index') ?? '#'); ?>" class="border border-gray-200 rounded-lg p-4 text-center hover:border-primary-300 hover:shadow-md transition">
            ...
            <a href="<?php echo e(route('clients.index') ?? '#'); ?>" class="border border-gray-200 rounded-lg p-4 text-center hover:border-primary-300 hover:shadow-md transition">
            ...
            <a href="<?php echo e(route('fournisseurs.index') ?? '#'); ?>" class="border border-gray-200 rounded-lg p-4 text-center hover:border-primary-300 hover:shadow-md transition">
            ...
            <a href="<?php echo e(route('stock.products.index') ?? '#'); ?>" class="border border-gray-200 rounded-lg p-4 text-center hover:border-primary-300 hover:shadow-md transition">
