...
<?php $__env->startSection('title', 'Modifier un Service'); ?>
...
unset($__errorArgs, $__bag); ?>"
                              rows="4" required><?php echo e(old('description', $service->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                              rows="6" required><?php echo e(old('content', $service->content)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\services\edit.blade.php ENDPATH**/ ?>