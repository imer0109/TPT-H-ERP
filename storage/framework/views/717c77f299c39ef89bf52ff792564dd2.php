...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="<?php echo e(route('cash.natures.update', $nature)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4">
                    <div>
                        ...
                        <input type="text" name="nom" id="nom" value="<?php echo e(old('nom', $nature->nom)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-red-500 border focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?php echo e(old('description', $nature->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="actif" name="actif" type="checkbox" <?php echo e($nature->actif ? 'checked' : ''); ?>
            ...
            <div class="flex justify-end">
                <a href="<?php echo e(route('cash.natures.index')); ?>" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    Annuler
                </a>
