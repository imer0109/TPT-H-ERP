...
<?php $__env->startSection('title', 'Tableau de bord Ressources Humaines'); ?>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center p-3 bg-blue-50 rounded">
                    ...
                    <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-sm"><?php echo e($presentToday); ?></span>
                </div>
