...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div class="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-5 rounded-2xl shadow-md hover:shadow-lg transition">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-sm opacity-80">Total Connecteurs</p>
                    <h2 class="text-3xl font-bold"><?php echo e($stats['total_connectors']); ?></h2>
                </div>
        ...
        <div class="bg-gradient-to-r from-green-600 to-green-500 text-white p-5 rounded-2xl shadow-md hover:shadow-lg transition">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold"><?php echo e($stats['active_connectors']); ?></h2>
                </div>
        ...
        <div class="bg-gradient-to-r from-cyan-600 to-cyan-500 text-white p-5 rounded-2xl shadow-md hover:shadow-lg transition">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold"><?php echo e($stats['recent_syncs']); ?></h2>
                </div>
        ...
        <div class="bg-gradient-to-r from-red-600 to-red-500 text-white p-5 rounded-2xl shadow-md hover:shadow-lg transition">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold"><?php echo e($stats['failed_syncs']); ?></h2>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-4 py-3 font-medium text-gray-800"><?php echo e($log->connector->name); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($log->connector->company->raison_sociale ?? 'N/A'); ?></td>
                                <td class="px-4 py-3">
                                    <span class="px-3 py-1 text-xs rounded-full bg-blue-100 text-blue-700 font-semibold">
                                        <?php echo e($log->connector->getTypeLabel()); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3">
                                    <span class="px-3 py-1 text-xs rounded-full font-semibold 
                                        <?php echo e($log->status === 'success' ? 'bg-green-100 text-green-700' : 
                                ...
                                <td class="px-4 py-3 text-gray-600">
                                    ...
                                    <br><span class="text-xs text-gray-400"><?php echo e($log->started_at->diffForHumans()); ?></span>
                                </td>
                                <td class="px-4 py-3 text-gray-600">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div class="p-6">
                <?php if($connectorsByType->count() > 0): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(ctx, {
            ...
            data: {
                labels: [
                    <?php $__currentLoopData = $connectorsByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e(\App\Models\ApiConnector::getConnectorTypes()[$type] ?? $type); ?>',
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                datasets: [{
                    data: [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\api-connectors\dashboard.blade.php ENDPATH**/ ?>