    ...
    <div class="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('supplier.portal.orders')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                    Voir tout
                </a>
            </div>
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('supplier.portal.deliveries')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                    Voir tout
                </a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">BL</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Date</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Commande</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Statut</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 bg-white">
    ...
    <div class="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('supplier.portal.contracts')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                    Voir tout
                </a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Contrat</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Fin</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Jours restants</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 bg-white">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('supplier.portal.issues')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                    Voir tout
                </a>
            </div>
            <div class="overflow-x-auto">
