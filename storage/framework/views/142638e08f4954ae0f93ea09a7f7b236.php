...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <form action="<?php echo e(route('hr.positions.store')); ?>" method="POST" class="px-4 py-5 sm:p-6">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="parent_position_id" name="parent_position_id" 
                        ...
                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pos->id); ?>" <?php echo e(old('parent_position_id') == $pos->id ? 'selected' : ''); ?>>
                ...
                <div class="sm:col-span-2">
                    <div class="flex items-center">
                        <input id="is_management" name="is_management" type="checkbox" 
                               ...
                               <?php echo e(old('is_management') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\positions\create.blade.php ENDPATH**/ ?>