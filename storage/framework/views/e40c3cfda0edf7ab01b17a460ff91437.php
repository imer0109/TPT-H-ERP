...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
            <?php if($rootPositions->count() > 0): ?>
                <div class="organizational-chart">
                    <?php $__currentLoopData = $rootPositions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rootPosition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('positions._chart-node', ['position' => $rootPosition], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\positions\organizational-chart.blade.php ENDPATH**/ ?>