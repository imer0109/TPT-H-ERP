...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="<?php echo e(route('accounting.chart-of-accounts.store')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="parent_id" id="parent_id"
                        ...
                        <?php if(isset($parent)): ?>
                            <option value="<?php echo e($parent->id); ?>" selected>
                                <?php echo e($parent->code); ?> - <?php echo e($parent->label); ?>
                ...
                <div>
                    ...
                    <select name="account_type" id="account_type" required
                        ...
                        <?php $__currentLoopData = \App\Models\ChartOfAccount::ACCOUNT_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('account_type') == $key ? 'selected' : ''); ?>>
                                <?php echo e($value); ?>
                ...
                <div>
                    ...
                    <select name="account_nature" id="account_nature" required
                        ...
                        <?php $__currentLoopData = \App\Models\ChartOfAccount::ACCOUNT_NATURES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('account_nature') == $key ? 'selected' : ''); ?>>
                                <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_auxiliary" id="is_auxiliary" value="1" 
                           <?php echo e(old('is_auxiliary') ? 'checked' : ''); ?>
                ...
                <!-- Type auxiliaire -->
                <div id="aux_type_container" class="<?php echo e(old('is_auxiliary') ? '' : 'hidden'); ?>">
                    ...
                    <select name="aux_type" id="aux_type"
                        ...
                        <?php $__currentLoopData = \App\Models\ChartOfAccount::AUX_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('aux_type') == $key ? 'selected' : ''); ?>>
                                <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="vat_applicable" id="vat_applicable" value="1" 
                           <?php echo e(old('vat_applicable') ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input type="text" name="syscohada_code" id="syscohada_code" value="<?php echo e(old('syscohada_code')); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"
                           placeholder="Ex: 411">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"
                              placeholder="Description du compte..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\accounting\chart-of-accounts\create.blade.php ENDPATH**/ ?>