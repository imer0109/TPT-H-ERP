...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="<?php echo e(route('permissions.update', $permission)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="resource" id="resource" value="<?php echo e(old('resource', $permission->resource)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-red-500 focus:border-red-500 block border py-2 w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?php echo e(old('description', $permission->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="action" id="action" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md">
                            <option value="create" <?php echo e(old('action', $permission->action) === 'create' ? 'selected' : ''); ?>>Créer</option>
                            <option value="read" <?php echo e(old('action', $permission->action) === 'read' ? 'selected' : ''); ?>>Lire</option>
                            <option value="update" <?php echo e(old('action', $permission->action) === 'update' ? 'selected' : ''); ?>>Modifier</option>
                            <option value="delete" <?php echo e(old('action', $permission->action) === 'delete' ? 'selected' : ''); ?>>Supprimer</option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\permissions\edit.blade.php ENDPATH**/ ?>