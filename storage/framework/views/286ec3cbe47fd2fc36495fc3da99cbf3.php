...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-2xl font-bold text-gray-800">Modifier l'utilisateur <?php echo e($user->prenom); ?> <?php echo e($user->nom); ?></h2>
        </div>
        
        <form action="<?php echo e(route('user-profiles.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" name="telephone" id="telephone" value="<?php echo e(old('telephone', $user->telephone)); ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <?php if($user->photo): ?>
                            <div class="mt-2">
                                ...
                                <img src="<?php echo e(Storage::url($user->photo)); ?>" alt="Photo de profil" class="w-16 h-16 rounded-full object-cover mt-1">
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex justify-between">
                    <a href="<?php echo e(route('user-profiles.show', $user->id)); ?>" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 hover:bg-gray-300 rounded-md">
                        Annuler
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\user-profiles\edit.blade.php ENDPATH**/ ?>