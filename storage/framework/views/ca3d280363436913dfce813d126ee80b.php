    ...
    <div class="max-w-7xl mx-auto bg-white shadow-xl rounded-2xl p-8">
        <div class="flex justify-between items-center mb-6 border-b pb-4">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('accounting.export.trial-balance-pdf', request()->all())); ?>" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="date" name="date_end" 
                           value="<?php echo e(request('date_end', $date_end)); ?>"
        ...
        <?php if(count($balances) > 0): ?>
                ...
                <table class="min-w-full text-sm text-left border border-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <?php $__currentLoopData = $balances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-2"><?php echo e($balance['account']->code); ?></td>
                                <td class="px-4 py-2"><?php echo e($balance['account']->name); ?></td>
                                <td class="px-4 py-2 text-right"><?php echo e(number_format($balance['debit'], 2)); ?></td>
                                <td class="px-4 py-2 text-right"><?php echo e(number_format($balance['credit'], 2)); ?></td>
                                <td class="px-4 py-2 text-right text-green-600">
                                    <?php echo e($balance['balance'] > 0 ? number_format($balance['balance'], 2) : ''); ?>

                                </td>
                                <td class="px-4 py-2 text-right text-red-600">
                                    <?php echo e($balance['balance'] < 0 ? number_format(abs($balance['balance']), 2) : ''); ?>
                    ...
                    <tfoot class="bg-indigo-50 font-semibold">
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right text-green-600"><?php echo e(number_format($totalDebitBalance, 2)); ?></td>
                            <td class="px-4 py-3 text-right text-red-600"><?php echo e(number_format($totalCreditBalance, 2)); ?></td>
                        </tr>
                        <tr class="border-t border-gray-200">
                            <td colspan="4" class="px-4 py-3 font-semibold">DIFFÉRENCE (Débit - Crédit)</td>
                            <td colspan="2" class="px-4 py-3 text-right <?php echo e(($totalDebit - $totalCredit) >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e(number_format($totalDebit - $totalCredit, 2)); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
                <div class="bg-indigo-600 text-white rounded-xl p-5 text-center shadow-md">
                    ...
                    <h3 class="text-2xl font-bold mt-1"><?php echo e(number_format($totalDebit, 2)); ?></h3>
                </div>
                <div class="bg-green-600 text-white rounded-xl p-5 text-center shadow-md">
                    <h5 class="text-sm font-medium">Total Crédits</h5>
                    <h3 class="text-2xl font-bold mt-1"><?php echo e(number_format($totalCredit, 2)); ?></h3>
                </div>
                <div class="bg-blue-500 text-white rounded-xl p-5 text-center shadow-md">
                    <h5 class="text-sm font-medium">Soldes Débiteurs</h5>
                    <h3 class="text-2xl font-bold mt-1"><?php echo e(number_format($totalDebitBalance, 2)); ?></h3>
                </div>
                <div class="bg-yellow-500 text-white rounded-xl p-5 text-center shadow-md">
                    <h5 class="text-sm font-medium">Soldes Créditeurs</h5>
                    <h3 class="text-2xl font-bold mt-1"><?php echo e(number_format($totalCreditBalance, 2)); ?></h3>
                </div>
            </div>
        <?php else: ?>
            <div class="mt-6 bg-blue-50 border border-blue-200 text-blue-700 rounded-lg p-4 flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\accounting\reports\trial-balance.blade.php ENDPATH**/ ?>