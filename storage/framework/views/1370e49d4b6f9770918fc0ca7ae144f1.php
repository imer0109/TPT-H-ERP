...
<?php $__env->startSection('title', 'Nouveau Workflow de Validation'); ?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">Nouveau Workflow de Validation</h2>

                <form action="<?php echo e(route('validations.workflows.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"><?php echo e(old('description')); ?></textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="module" id="module" 
                                    ...
                                    <option value="accounting" <?php echo e(old('module') == 'accounting' ? 'selected' : ''); ?>>Comptabilité</option>
                                    <option value="purchases" <?php echo e(old('module') == 'purchases' ? 'selected' : ''); ?>>Achats</option>
                                    <option value="inventory" <?php echo e(old('module') == 'inventory' ? 'selected' : ''); ?>>Stock</option>
                                    <option value="hr" <?php echo e(old('module') == 'hr' ? 'selected' : ''); ?>>Ressources Humaines</option>
                                    <option value="sales" <?php echo e(old('module') == 'sales' ? 'selected' : ''); ?>>Ventes</option>
                                    <option value="companies" <?php echo e(old('module') == 'companies' ? 'selected' : ''); ?>>Sociétés</option>
                                    <option value="agencies" <?php echo e(old('module') == 'agencies' ? 'selected' : ''); ?>>Agences</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="entity_type" id="entity_type" 
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                       value="<?php echo e(old('entity_type')); ?>" required
                                       placeholder="App\Models\ExampleModel">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\validations\workflows\create.blade.php ENDPATH**/ ?>