...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800"><?php echo e($company->raison_sociale); ?></h1>
            <p class="text-gray-600"><?php echo e($company->type === 'holding' ? 'Société mère' : 'Filiale'); ?></p>
        </div>
        <div class="flex space-x-2">
            <a href="<?php echo e(route('audit-trails.company', $company->id)); ?>" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg">
                Historique
            </a>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <div class="space-y-2">
                    <p><span class="font-medium">Raison sociale:</span> <?php echo e($company->raison_sociale); ?></p>
                    <p><span class="font-medium">Type:</span> 
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            <?php echo e($company->type === 'holding' ? 'bg-primary-100 text-primary-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e($company->type === 'holding' ? 'Holding' : 'Filiale'); ?>

                        </span>
                    </p>
                    <p><span class="font-medium">Secteur d'activité:</span> <?php echo e($company->secteur_activite); ?></p>
                    <p><span class="font-medium">Devise:</span> <?php echo e($company->devise); ?></p>
                    <p><span class="font-medium">Statut:</span> 
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            <?php echo e($company->active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
            ...
            <div>
                ...
                <div class="space-y-2">
                    <p><span class="font-medium">Pays:</span> <?php echo e($company->pays); ?></p>
                    <p><span class="font-medium">Ville:</span> <?php echo e($company->ville); ?></p>
                    <p><span class="font-medium">Siège social:</span> <?php echo e($company->siege_social); ?></p>
                    <p><span class="font-medium">Email:</span> <?php echo e($company->email ?? '-'); ?></p>
                    <p><span class="font-medium">Téléphone:</span> <?php echo e($company->telephone ?? '-'); ?></p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2">
                    <p><span class="font-medium">NIU:</span> <?php echo e($company->niu ?? '-'); ?></p>
                    <p><span class="font-medium">RCCM:</span> <?php echo e($company->rccm ?? '-'); ?></p>
                    <p><span class="font-medium">Régime fiscal:</span> <?php echo e($company->regime_fiscal ?? '-'); ?></p>
                    <p><span class="font-medium">Site web:</span> 
                        <?php if($company->site_web): ?>
                            <a href="<?php echo e($company->site_web); ?>" target="_blank" class="text-primary-600 hover:text-primary-800">
                                <?php echo e($company->site_web); ?>
        ...
        <?php if($company->logo || $company->visuel): ?>
            ...
            <div class="flex space-x-4">
                <?php if($company->logo): ?>
                    <div>
                        ...
                        <img src="<?php echo e(Storage::url($company->logo)); ?>" alt="Logo" class="h-20 w-20 object-cover rounded">
                    </div>
                <?php endif; ?>
                <?php if($company->visuel): ?>
                    <div>
                        <p class="text-sm text-gray-600 mb-1">Visuel</p>
                        <img src="<?php echo e(Storage::url($company->visuel)); ?>" alt="Visuel" class="h-20 w-20 object-cover rounded">
                    </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e(number_format($totalBalance, 2, ',', ' ')); ?> <?php echo e($company->devise); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e($agencies->count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e(number_format($encaissements, 2, ',', ' ')); ?> <?php echo e($company->devise); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e(number_format($netCashFlow, 2, ',', ' ')); ?> <?php echo e($company->devise); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e(number_format($averageTransaction, 2, ',', ' ')); ?> <?php echo e($company->devise); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="border rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold"><?php echo e(number_format($decaissements, 2, ',', ' ')); ?> <?php echo e($company->devise); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('bank-accounts.index')); ?>" class="text-primary-600 hover:text-primary-800 text-sm">
                    Voir tout
                </a>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('policies.index')); ?>" class="text-primary-600 hover:text-primary-800 text-sm">
                    Voir tout
                </a>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('tax-regulations.index')); ?>" class="text-primary-600 hover:text-primary-800 text-sm">
                    Voir tout
                </a>
            </div>
    ...
    <?php if($company->isHolding() && count($subsidiariesData) > 0): ?>
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $subsidiariesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subsidiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($subsidiary['name']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($subsidiary['balance'], 2, ',', ' ')); ?> <?php echo e($company->devise); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($subsidiary['encaissements'], 2, ',', ' ')); ?> <?php echo e($company->devise); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($subsidiary['decaissements'], 2, ',', ' ')); ?> <?php echo e($company->devise); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($subsidiary['agencies_count']); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views/companies/dashboard/company.blade.php ENDPATH**/ ?>