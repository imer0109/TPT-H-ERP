...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow rounded-xl p-6">
        <form action="<?php echo e(route('api-connectors.api-connectors.update', $apiConnector)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $apiConnector->name)); ?>" required
                    ...
                    <div class="relative">
                        <select name="company_id" required
                            ...
                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($company->id); ?>" <?php echo e(old('company_id', $apiConnector->company_id) == $company->id ? 'selected' : ''); ?>>
                    ...
                    <div class="relative">
                        <select name="type" required
                            ...
                            <?php $__currentLoopData = $connectorTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('type', $apiConnector->type) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full rounded-lg border border-gray-300 py-2.5 px-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400"
                              placeholder="Description du connecteur..."><?php echo e(old('description', $apiConnector->description)); ?></textarea>
                    ...
                    <div class="relative">
                        <select name="sync_frequency" required
                            ...
                            <?php $__currentLoopData = $syncFrequencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('sync_frequency', $apiConnector->sync_frequency) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center pt-6">
                    <input type="checkbox" name="is_active" id="is_active" 
                           ...
                           <?php echo e(old('is_active', $apiConnector->is_active) ? 'checked' : ''); ?>>
            ...
            <div class="mt-8 border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" name="configuration[url]" value="<?php echo e(old('configuration.url', $apiConnector->getConfig('url'))); ?>"
                               class="w-full rounded-lg border border-gray-300 py-2.5 px-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="configuration[api_key]" value="<?php echo e(old('configuration.api_key', $apiConnector->getConfig('api_key'))); ?>"
                               class="w-full rounded-lg border border-gray-300 py-2.5 px-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="configuration[username]" value="<?php echo e(old('configuration.username', $apiConnector->getConfig('username'))); ?>"
                               class="w-full rounded-lg border border-gray-300 py-2.5 px-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\api-connectors\edit.blade.php ENDPATH**/ ?>