...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="<?php echo e(route('stock.movements.create')); ?>" class="bg-primary-600 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded transition">
                Nouveau Mouvement
            </a>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-primary-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm font-medium flex space-x-2 border-r">
                            <a href="<?php echo e(route('stock.movements.show', $movement)); ?>" class="text-primary-600 hover:text-primary-900 transition">Détails</a>
