...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('cash.registers.store')); ?>" method="POST" id="cashRegisterForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 flex justify-end gap-3">
                <a href="<?php echo e(route('cash.registers.index')); ?>" class="px-4 py-2 border rounded">
                    Annuler
                </a>
