...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Modifier la Réglementation Fiscale</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="<?php echo e(route('tax-regulations.update', $taxRegulation)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="company_id" id="company_id"
                                ...
                                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($company->id); ?>" <?php echo e(old('company_id', $taxRegulation->company_id) == $company->id ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="agency_id" id="agency_id"
                                ...
                                <?php $__currentLoopData = $agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($agency->id); ?>" <?php echo e(old('agency_id', $taxRegulation->agency_id) == $agency->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="tax_type" id="tax_type"
                           value="<?php echo e(old('tax_type', $taxRegulation->tax_type)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="rate" id="rate"
                           value="<?php echo e(old('rate', $taxRegulation->rate)); ?>"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full py-2 shadow-sm sm:text-sm border border-gray-300 rounded-md" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full py-2 shadow-sm sm:text-sm border border-gray-300 rounded-md"><?php echo e(old('description', $taxRegulation->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="effective_date" id="effective_date"
                           value="<?php echo e(old('effective_date', $taxRegulation->effective_date ? $taxRegulation->effective_date->format('Y-m-d') : null)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="expiry_date" id="expiry_date"
                           value="<?php echo e(old('expiry_date', $taxRegulation->expiry_date ? $taxRegulation->expiry_date->format('Y-m-d') : null)); ?>"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full py-2 shadow-sm sm:text-sm border border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="is_active" id="is_active"
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm">
                        <option value="1" <?php echo e(old('is_active', $taxRegulation->is_active) == 1 ? 'selected' : ''); ?>>Actif</option>
                        <option value="0" <?php echo e(old('is_active', $taxRegulation->is_active) == 0 ? 'selected' : ''); ?>>Inactif</option>
                    </select>
                </div>
            </div>
            ...
            <div class="mt-6">
                <button type="submit"
                    ...
                    Mettre à jour la réglementation fiscale
                </button>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\tax-regulations\edit.blade.php ENDPATH**/ ?>