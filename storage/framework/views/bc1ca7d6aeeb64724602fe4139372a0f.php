<?php $__env->startSection('content'); ?>
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <a href="<?php echo e(route('client-interactions.edit', $interaction->id)); ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2">
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-base font-medium">
                                <a href="<?php echo e(route('clients.show', $interaction->client->id)); ?>" class="text-red-600 hover:text-red-800">
                                    <?php echo e($interaction->client->nom_raison_sociale); ?> (<?php echo e($interaction->client->code_client); ?>)
                                </a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-base"><?php echo e($interaction->date_interaction->format('d/m/Y H:i')); ?></p>
                        </div>
                        
                        <div>
                            <p class="text-sm font-medium text-gray-500">Utilisateur</p>
                            <p class="text-base"><?php echo e($interaction->user->name); ?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-base"><?php echo e($interaction->date_suivi->format('d/m/Y')); ?></p>
                        </div>
                        <?php endif; ?>
                        
                        <?php if($interaction->campagne): ?>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Campagne</p>
                            <p class="text-base"><?php echo e($interaction->campagne->nom); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-md">
                        <p class="whitespace-pre-line"><?php echo e($interaction->description); ?></p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-md">
                        <p class="whitespace-pre-line"><?php echo e($interaction->resultat); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="md:col-span-1">
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div class="space-y-2">
                        <?php if($interaction->suivi_necessaire && !$interaction->suivi_complete): ?>
                        <form action="<?php echo e(route('client-interactions.mark-followed-up', $interaction->id)); ?>" method="POST" class="mb-2">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('client-interactions.destroy', $interaction->id)); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette interaction ?');">
                            <?php echo csrf_field(); ?>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <form action="<?php echo e(route('client-interactions.upload-document', $interaction->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\client-interactions\show.blade.php ENDPATH**/ ?>