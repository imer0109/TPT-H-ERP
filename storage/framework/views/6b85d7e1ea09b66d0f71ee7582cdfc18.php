...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <button onclick="window.location.href='<?php echo e(route('hr.documents.work-certificate', ['employee' => auth()->user()->employee ?? 1])); ?>'" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4">
                    <button onclick="window.location.href='<?php echo e(route('hr.documents.salary-certificate', ['employee' => auth()->user()->employee ?? 1])); ?>'" 
    ...
    <div class="mt-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <?php if(isset($recentDocuments) && $recentDocuments->count() > 0): ?>
                            ...
                            <div class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <p class="text-sm font-medium truncate">
                                        <?php switch($document->type_document):
                                            case ('contrat'): ?>
                                                <span class="text-blue-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php case ('bon_commande'): ?>
                                                <span class="text-green-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php case ('fiche_ouverture'): ?>
                                                <span class="text-purple-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php case ('rccm'): ?>
                                                <span class="text-yellow-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php case ('niu'): ?>
                                                <span class="text-indigo-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php case ('piece_identite'): ?>
                                                <span class="text-pink-600"><?php echo e($document->nom); ?></span>
                                                <?php break; ?>
                                            <?php default: ?>
                                                <span class="text-gray-600"><?php echo e($document->nom); ?></span>
                                        <?php endswitch; ?>
                                    </p>
                                ...
                                <div class="mt-2 sm:flex sm:justify-between">
                                    <div class="sm:flex">
                                        <p class="flex items-center text-sm text-gray-500">
                                            ...
                                            <?php echo e($document->type_document); ?>
                                    ...
                                    <div class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                                        ...
                                        <p><?php echo e($document->created_at->format('d M Y')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\hr\documents\index.blade.php ENDPATH**/ ?>