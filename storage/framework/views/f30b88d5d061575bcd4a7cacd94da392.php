<?php $__env->startSection('title', 'Modifier la Réclamation'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Modifier la Réclamation #<?php echo e($reclamation->id); ?></h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('clients.reclamations.update', $reclamation)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="produit_defectueux" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'produit_defectueux' ? 'selected' : ''); ?>>
                                            Produit Défectueux
                                        </option>
                                        <option value="retard_livraison" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'retard_livraison' ? 'selected' : ''); ?>>
                                            Retard de Livraison
                                        </option>
                                        <option value="erreur_facturation" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'erreur_facturation' ? 'selected' : ''); ?>>
                                            Erreur de Facturation
                                        </option>
                                        <option value="service_client" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'service_client' ? 'selected' : ''); ?>>
                                            Service Client
                                        </option>
                                        <option value="qualite_produit" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'qualite_produit' ? 'selected' : ''); ?>>
                                            Qualité du Produit
                                        </option>
                                        <option value="autre" <?php echo e(old('type_reclamation', $reclamation->type_reclamation) == 'autre' ? 'selected' : ''); ?>>
                                            Autre
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Décrivez la réclamation..." required><?php echo e(old('description', $reclamation->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Solution proposée..."><?php echo e(old('solution', $reclamation->solution)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Commentaires..."><?php echo e(old('commentaires', $reclamation->commentaires)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('clients.reclamations.show', $reclamation)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\clients\reclamations\edit.blade.php ENDPATH**/ ?>