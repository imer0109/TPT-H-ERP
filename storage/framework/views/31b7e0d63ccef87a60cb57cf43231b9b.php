        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="border-t border-slate-800 p-4 bg-slate-950">
                <div class="flex items-center w-full">
                    ...
                    <div class="ml-2">
                        <a href="<?php echo e(route('user-management.profile.edit')); ?>" class="text-slate-400 hover:text-white p-1 rounded-md hover:bg-slate-800 transition-colors" title="Mon Profil">
