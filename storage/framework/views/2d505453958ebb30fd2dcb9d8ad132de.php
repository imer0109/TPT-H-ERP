        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Modifier la livraison</h2>
                ...
                <form action="<?php echo e(route('purchases.deliveries.update', $delivery)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="numero_bl" id="numero_bl" 
                                   ...
                                   value="<?php echo e(old('numero_bl', $delivery->numero_bl)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_reception" id="date_reception" 
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                   value="<?php echo e(old('date_reception', $delivery->date_reception->format('Y-m-d'))); ?>" required>
                        ...
                        <div>
                            ...
                            <select name="warehouse_id" id="warehouse_id" 
                                ...
                                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($warehouse->id); ?>" <?php echo e(old('warehouse_id', $delivery->warehouse_id) == $warehouse->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="condition_emballage" id="condition_emballage" 
                                ...
                                <option value="bon" <?php echo e(old('condition_emballage', $delivery->condition_emballage) == 'bon' ? 'selected' : ''); ?>>Bon</option>
                                <option value="moyen" <?php echo e(old('condition_emballage', $delivery->condition_emballage) == 'moyen' ? 'selected' : ''); ?>>Moyen</option>
                                <option value="mauvais" <?php echo e(old('condition_emballage', $delivery->condition_emballage) == 'mauvais' ? 'selected' : ''); ?>>Mauvais</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="notes" id="notes" rows="3" 
                                  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"><?php echo e(old('notes', $delivery->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Articles livrés</h3>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $delivery->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" name="items[<?php echo e($index); ?>][quantite_livree]" 
                                                       ...
                                                       min="0" value="<?php echo e(old('items.' . $index . '.quantite_livree', $item->quantite_livree)); ?>" required>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <span class="ecart-display text-sm font-medium <?php echo e($item->ecart > 0 ? 'text-green-600' : ($item->ecart < 0 ? 'text-red-600' : '')); ?>">
                                                    <?php echo e($item->ecart); ?>

                                                </span>
                                                <input type="hidden" name="items[<?php echo e($index); ?>][ecart]" class="ecart-input" value="<?php echo e($item->ecart); ?>">
                                            </td>
                                            <td class="px-6 py-4">
                                                <input type="text" name="items[<?php echo e($index); ?>][notes]" 
                                                       ...
                                                       value="<?php echo e(old('items.' . $index . '.notes', $item->notes)); ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.quantite-livree').forEach(function(input) {
        input.addEventListener('input', function() {
            ...
            // Get the quantity ordered from the previous cell
            const quantiteCommandee = parseInt(row.querySelector('td:nth-child(2) .text-sm').textContent);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\purchases\deliveries\edit.blade.php ENDPATH**/ ?>