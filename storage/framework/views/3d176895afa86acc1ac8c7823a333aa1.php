...
<div class="container mx-auto px-6 py-8">
    ...
    <form method="post" action="<?php echo e(route('fournisseurs.orders.store')); ?>" onsubmit="return false;" class="bg-white p-6 rounded shadow space-y-4">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="date" name="date_commande" id="date_commande" class="form-input w-full" value="<?php echo e(date('Y-m-d')); ?>" />
            </div>
            <div>
        ...
        <div class="flex gap-3">
            ...
            <a href="<?php echo e(route('fournisseurs.orders.index')); ?>" class="btn">Annuler</a>
        </div>
    </form>
    ...
    <script>
        ...
        function submitOrder(){
            ...
            fetch("<?php echo e(route('fournisseurs.orders.store')); ?>",{
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\fournisseurs\orders\create.blade.php ENDPATH**/ ?>