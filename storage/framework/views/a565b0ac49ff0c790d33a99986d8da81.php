            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"><?php echo e(number_format($cashSession->cashRegister->solde_actuel, 2, ',', ' ')); ?> FCFA</dd>
                    </div>
                </dl>
            </div>
        </div>

        <form action="<?php echo e(route('cash-transactions.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="cash_session_id" value="<?php echo e($cashSession->id); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="transaction_nature_id" id="transaction_nature_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md">
                            ...
                            <?php $__currentLoopData = $transactionNatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($nature->id); ?>" <?php echo e(old('transaction_nature_id') == $nature->id ? 'selected' : ''); ?>><?php echo e($nature->nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['transaction_nature_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="date_transaction" id="date_transaction" value="<?php echo e(old('date_transaction', now()->format('Y-m-d\TH:i'))); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="montant" id="montant" value="<?php echo e(old('montant')); ?>" step="0.01" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="reference" id="reference" value="<?php echo e(old('reference')); ?>"
                            class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3" class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\cash-transactions\create.blade.php ENDPATH**/ ?>