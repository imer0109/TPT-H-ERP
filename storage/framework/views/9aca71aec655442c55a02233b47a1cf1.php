...
<div class="space-y-6">
            ...
            <div>
                ...
                <?php if($purchaseRequest): ?>
                    <p class="text-blue-600 text-sm mt-1">
                        <i class="fas fa-link mr-1"></i>Créé depuis la DA: <?php echo e($purchaseRequest->code); ?>
    ...
    <!-- Formulaire -->
    <form method="POST" action="<?php echo e(route('purchases.orders.store')); ?>" id="order-form">
        <?php echo csrf_field(); ?>
        <?php if($purchaseRequest): ?>
            <input type="hidden" name="purchase_request_id" value="<?php echo e($purchaseRequest->id); ?>">
        <?php endif; ?>
                    ...
                    <select name="fournisseur_id" id="fournisseur_id" required 
                        ...
                        <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($fournisseur->id); ?>" 
                                    <?php echo e(old('fournisseur_id', $purchaseRequest ? $purchaseRequest->fournisseur_suggere_id : '') == $fournisseur->id ? 'selected' : ''); ?>>
                    ...
                    <select name="agency_id" id="agency_id" required
                        ...
                        <?php $__currentLoopData = $agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($agency->id); ?>" 
                                    <?php echo e(old('agency_id', $purchaseRequest ? $purchaseRequest->agency_id : '') == $agency->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="nature_achat" id="nature_achat" required 
                        ...
                        <option value="Bien" <?php echo e(old('nature_achat', $purchaseRequest ? $purchaseRequest->nature_achat : '') == 'Bien' ? 'selected' : ''); ?>>Bien</option>
                        <option value="Service" <?php echo e(old('nature_achat', $purchaseRequest ? $purchaseRequest->nature_achat : '') == 'Service' ? 'selected' : ''); ?>>Service</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="devise" id="devise" required 
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500">
                        <option value="XOF" <?php echo e(old('devise') == 'XOF' ? 'selected' : ''); ?>>XOF (Franc CFA)</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="delai_contractuel" id="delai_contractuel" 
                           value="<?php echo e(old('delai_contractuel', $purchaseRequest ? $purchaseRequest->date_echeance_souhaitee : '')); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="conditions_paiement" id="conditions_paiement" 
                           value="<?php echo e(old('conditions_paiement')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="adresse_livraison" id="adresse_livraison" rows="2"
                              ...
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"><?php echo e(old('adresse_livraison')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="2"
                              ...
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500"><?php echo e(old('notes', $purchaseRequest ? $purchaseRequest->notes : '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div id="items-container">
                <?php if($purchaseRequest && $purchaseRequest->items->count() > 0): ?>
                    <?php $__currentLoopData = $purchaseRequest->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $requestItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('purchases.orders._item_form', ['index' => $index, 'item' => $requestItem], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php elseif(old('items')): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    let itemIndex = <?php echo e($purchaseRequest && $purchaseRequest->items->count() > 0 ? $purchaseRequest->items->count() : (old('items') ? count(old('items')) : 1)); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\purchases\orders\create.blade.php ENDPATH**/ ?>