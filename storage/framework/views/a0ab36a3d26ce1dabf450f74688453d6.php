...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Créer une nouvelle affectation pour <?php echo e($employee->full_name); ?></p>
        </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="<?php echo e(route('hr.employees.assignments.store', $employee)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <input type="date" name="start_date" id="start_date" value="<?php echo e(old('start_date')); ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <input type="date" name="end_date" id="end_date" value="<?php echo e(old('end_date')); ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-6">
                        <div class="flex items-center">
                            <input id="is_primary" name="is_primary" type="checkbox" <?php echo e(old('is_primary') ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\employees\assignments\create.blade.php ENDPATH**/ ?>