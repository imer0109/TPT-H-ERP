    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="p-4 grid grid-cols-2 gap-4">
                    <a href="<?php echo e(route('stock.movements.create', ['warehouse_id' => $warehouse->id])); ?>" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-3 rounded text-center transition">
