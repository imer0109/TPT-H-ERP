                ...
                <div class="space-y-2">
                    ...
                    <p><span class="font-medium">Type:</span> 
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            <?php echo e($company->type === 'holding' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'); ?>">
                ...
                <div class="space-y-2">
                    ...
                    <p><span class="font-medium">Site web:</span> 
                        <?php if($company->site_web): ?>
                            <a href="<?php echo e($company->site_web); ?>" target="_blank" class="text-blue-600 hover:text-blue-800">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Solde Total</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre d'Agences</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
