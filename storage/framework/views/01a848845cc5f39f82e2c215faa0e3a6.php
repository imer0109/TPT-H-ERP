...
<div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white shadow rounded p-4 flex flex-col justify-between">
            <div>
                <h4 class="text-xl font-bold text-primary-600"><?php echo e($costCenters->count()); ?></h4>
            ...
            <a href="<?php echo e(route('accounting.settings.cost-centers')); ?>" class="mt-2 inline-block text-sm text-primary-600 hover:underline">
                Gérer
            </a>
        </div>
        ...
        <div class="bg-white shadow rounded p-4 flex flex-col justify-between">
            <div>
                <h4 class="text-xl font-bold text-primary-600"><?php echo e($projects->count()); ?></h4>
            ...
            <a href="<?php echo e(route('accounting.settings.projects')); ?>" class="mt-2 inline-block text-sm text-primary-600 hover:underline">
                Gérer
            </a>
        </div>
        ...
        <div class="bg-white shadow rounded p-4 flex flex-col justify-between">
            <div>
                <h4 class="text-xl font-bold text-primary-600"><?php echo e($journals->count()); ?></h4>
            ...
            <a href="<?php echo e(route('accounting.settings.journals')); ?>" class="mt-2 inline-block text-sm text-primary-600 hover:underline">
                Gérer
            </a>
        </div>
        ...
        <!-- Sociétés -->
        <div class="bg-white shadow rounded p-4 flex flex-col justify-between">
            <h4 class="text-xl font-bold text-primary-600"><?php echo e($companies->count()); ?></h4>
    ...
    <div class="bg-white shadow rounded p-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="<?php echo e(route('accounting.settings.parameters')); ?>" class="flex flex-col items-center justify-center p-4 border rounded hover:bg-primary-50 transition">
