...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <form action="<?php echo e(route('hr.documents.salary-certificate.generate', $employee)); ?>" method="POST" id="salaryCertificateForm">
            <?php echo csrf_field(); ?>
            <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900"><?php echo e($employee->currentCompany->raison_sociale ?? 'N/A'); ?></p>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="number" name="gross_salary" id="gross_salary" required
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                               value="<?php echo e(old('gross_salary')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="number" name="net_salary" id="net_salary" required
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                               value="<?php echo e(old('net_salary')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rémi\Desktop\TPT INTERNATIONAL\PROJET TPT-H ERP\TPT-H ERP\resources\views\hr\documents\salary-certificate.blade.php ENDPATH**/ ?>