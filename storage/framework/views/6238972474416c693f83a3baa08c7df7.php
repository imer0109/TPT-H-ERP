            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <a href="<?php echo e(route('cash.transactions.create', $cashRegister)); ?>" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg">
                                ...
                                <p class="text-xl font-bold <?php echo e($balance >= 0 ? 'text-blue-600' : 'text-red-600'); ?>"><?php echo e(number_format($balance, 2, ',', ' ')); ?> FCFA</p>
                            </div>
                        </div>
                        <div>
