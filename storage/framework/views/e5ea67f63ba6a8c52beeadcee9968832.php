...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="<?php echo e(route('cash.natures.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-red-500 focus:border-red-500 block border w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?php echo e(old('description')); ?></textarea>
