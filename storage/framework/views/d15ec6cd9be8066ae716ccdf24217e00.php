    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex space-x-4">
            <form method="POST" action="<?php echo e(route('accounting.chart-of-accounts.syscohada')); ?>" class="inline" id="syscohada-form">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition <?php echo e(!request('company_id') ? 'opacity-50 cursor-not-allowed' : ''); ?>"
