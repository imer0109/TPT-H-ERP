        ...
        <form action="{{ route('companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 gap-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="regime_fiscal" id="regime_fiscal" value="{{ old('regime_fiscal', $company->regime_fiscal) }}"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 py-2 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    @error('regime_fiscal')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="secteur_activite" id="secteur_activite"
                           value="{{ old('secteur_activite', $company->secteur_activite) }}"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 py-2 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                ...
                <div>
                    ...
                    <input type="text" name="devise" id="devise"
                           value="{{ old('devise', $company->devise) }}"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 py-2 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                    @error('devise')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="siege_social" id="siege_social" rows="3"
                              class="mt-1 focus:ring-red-500 focus:border-red-500 py-2 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>{{ old('siege_social', $company->siege_social) }}</textarea>
                    @error('siege_social')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="url" name="site_web" id="site_web"
                           value="{{ old('site_web', $company->site_web) }}"
                           class="mt-1 focus:ring-red-500 focus:border-red-500 py-2 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    @error('site_web')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="file" name="logo" id="logo"
                           ...
                           class="mt-1 focus:ring-red-500 focus:border-red-500 block py-2 border w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    @if($company->logo)
                        <img id="logo-preview" src="{{ Storage::url($company->logo) }}" class="mt-3 w-24 h-24 object-contain border" />
                    @else
                ...
                <div>
                    ...
                    <input type="file" name="visuel" id="visuel"
                           ...
                           class="mt-1 focus:ring-red-500 focus:border-red-500 block py-2 border w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    @if($company->visuel)
                        <img id="visuel-preview" src="{{ Storage::url($company->visuel) }}" class="mt-3 w-24 h-24 object-contain border" />
                    @else
