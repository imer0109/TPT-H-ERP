...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <span class="text-gray-600">Bienvenue, {{ Auth::user()->prenom }} {{ Auth::user()->nom }}</span>
        </div>
    </div>
        ...
        <div class="divide-y divide-gray-200">
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-500">{{ now()->subMinutes(15)->format('d/m/Y H:i') }}</span>
                </div>
            </div>
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-500">{{ now()->subHours(1)->format('d/m/Y H:i') }}</span>
                </div>
            </div>
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-500">{{ now()->subHours(3)->format('d/m/Y H:i') }}</span>
                </div>
            </div>
        </div>
    </div>
