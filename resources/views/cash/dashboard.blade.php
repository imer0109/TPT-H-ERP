...
@section('title', 'Dashboard Caisse')

@section('content')
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Dashboard Caisse</h1>
        </div>

        <!-- Alerts -->
        @if(count($alerts) > 0)
        <div class="mb-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4">Alertes</h2>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <ul class="list-disc pl-5 space-y-1">
                            ...
                            <li class="text-sm text-yellow-700">{{ $alert['message'] }}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Caisses</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ $cashRegisters->count() }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
                            ...
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        {{ number_format($cashRegisters->sum('solde_actuel'), 2, ',', ' ') }} XAF
                                    </div>
                                </dd>
                            </dl>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Transactions Récentes</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ $recentTransactions->count() }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Soldes par Société</h3>
            </div>
            <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach($totalsByCompany as $companyId => $data)
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="text-sm font-medium text-gray-900">{{ $data['name'] }}</div>
                        <div class="mt-1 text-2xl font-semibold text-gray-900">
                            {{ number_format($data['total'], 2, ',', ' ') }} XAF
                        </div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Soldes par Agence</h3>
            </div>
            <div class="px-4 py-5 sm:p-6">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-primary-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-primary-700 uppercase tracking-wider">Agence</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($totalsByAgency as $agencyId => $data)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $data['name'] }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $data['company'] }}</td>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Encaissement</span>
                                    @else
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Décaissement</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ number_format($transaction->montant, 2, ',', ' ') }} XAF
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
