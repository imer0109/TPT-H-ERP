...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        <h1 class="text-2xl font-semibold text-gray-900 mb-6">Modifier le Rôle</h1>
        ...
        <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-red-500 focus:border-red-500 border block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $role->description) }}</textarea>
                        @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-2">{{ $module }}</h3>
                            <div class="space-y-2">
            ...
            <div class="flex justify-end">
                <a href="{{ route('roles.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    Annuler
                </a>
