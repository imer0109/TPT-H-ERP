...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('clients.loyalty.store', $client) }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="p-3 bg-gray-50 rounded-md font-mono">
                        {{ \App\Models\LoyaltyCard::generateCardNumber() }}
                    </div>
                ...
                <div>
                    ...
                    <input type="number" name="points" id="points" min="0" value="{{ old('points', 0) }}"
