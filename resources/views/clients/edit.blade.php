        ...
        <form action="{{ route('clients.update', $client) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="code_client" id="code_client" value="{{ old('code_client', $client->code_client) }}" readonly 
                ...
                <div>
                    ...
                    <select name="type_client" id="type_client" required 
                        ...
                        <option value="administration" {{ old('type_client', $client->type_client) == 'administration' ? 'selected' : '' }}>Administration</option>
                ...
                <div>
                    ...
                    <input type="text" name="nom_raison_sociale" id="nom_raison_sociale" value="{{ old('nom_raison_sociale', $client->nom_raison_sociale) }}" required 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                ...
                <div>
                    ...
                    <input type="url" name="site_web" id="site_web" value="{{ old('site_web', $client->site_web) }}" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                    @error('site_web')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="type_relation" id="type_relation" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                        <option value="">Sélectionner un type</option>
                        <option value="comptant" {{ old('type_relation', $client->type_relation) == 'comptant' ? 'selected' : '' }}>Comptant</option>
                        <option value="credit" {{ old('type_relation', $client->type_relation) == 'credit' ? 'selected' : '' }}>Crédit</option>
                        <option value="mixte" {{ old('type_relation', $client->type_relation) == 'mixte' ? 'selected' : '' }}>Mixte</option>
                    </select>
                    @error('type_relation')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="delai_paiement" id="delai_paiement" value="{{ old('delai_paiement', $client->delai_paiement) }}" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                ...
                <div>
                    ...
                    <input type="number" name="plafond_credit" id="plafond_credit" value="{{ old('plafond_credit', $client->plafond_credit) }}" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                ...
                <div>
                    ...
                    <select name="mode_paiement_prefere" id="mode_paiement_prefere" 
                        ...
                        <option value="especes" {{ old('mode_paiement_prefere', $client->mode_paiement_prefere) == 'especes' ? 'selected' : '' }}>Espèces</option>
                        <option value="cheque" {{ old('mode_paiement_prefere', $client->mode_paiement_prefere) == 'cheque' ? 'selected' : '' }}>Chèque</option>
                        <option value="virement" {{ old('mode_paiement_prefere', $client->mode_paiement_prefere) == 'virement' ? 'selected' : '' }}>Virement</option>
                        <option value="carte_bancaire" {{ old('mode_paiement_prefere', $client->mode_paiement_prefere) == 'carte_bancaire' ? 'selected' : '' }}>Carte bancaire</option>
                        <option value="mobile_money" {{ old('mode_paiement_prefere', $client->mode_paiement_prefere) == 'mobile_money' ? 'selected' : '' }}>Mobile Money</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="referent_commercial_id" id="referent_commercial_id" 
                        ...
                        @foreach($commerciaux as $commercial)
                            <option value="{{ $commercial->id }}" {{ old('referent_commercial_id', $client->referent_commercial_id) == $commercial->id ? 'selected' : '' }}>
                                ...
                                <div class="border rounded-lg p-3 flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="truncate max-w-xs">
                                            <p class="font-semibold text-sm">{{ $document->nom }}</p>
                                            <p class="text-xs text-gray-500">{{ number_format($document->taille / 1024, 2) }} KB</p>
                                        </div>
                                    </div>
                                    <div class="flex">
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="notes" id="notes" rows="4" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">{{ old('notes', $client->notes) }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('clients.show', $client) }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mr-2">
