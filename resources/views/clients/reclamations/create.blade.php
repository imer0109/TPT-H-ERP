    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('clients.reclamations.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if(isset($client))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type_reclamation" id="type_reclamation" class="form-control @error('type_reclamation') is-invalid @enderror" required>
                                        ...
                                        <option value="produit_defectueux" {{ old('type_reclamation') == 'produit_defectueux' ? 'selected' : '' }}>
                                            Produit Défectueux
                                        </option>
                                        <option value="retard_livraison" {{ old('type_reclamation') == 'retard_livraison' ? 'selected' : '' }}>
                                            Retard de Livraison
                                        </option>
                                        <option value="erreur_facturation" {{ old('type_reclamation') == 'erreur_facturation' ? 'selected' : '' }}>
                                            Erreur de Facturation
                                        </option>
                                        <option value="service_client" {{ old('type_reclamation') == 'service_client' ? 'selected' : '' }}>
                                            Service Client
                                        </option>
                                        <option value="qualite_produit" {{ old('type_reclamation') == 'qualite_produit' ? 'selected' : '' }}>
                                            Qualité du Produit
                                        </option>
                                        <option value="autre" {{ old('type_reclamation') == 'autre' ? 'selected' : '' }}>
                                            Autre
                                        </option>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Décrivez la réclamation..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="solution" id="solution" rows="3" class="form-control @error('solution') is-invalid @enderror" placeholder="Solution proposée...">{{ old('solution') }}</textarea>
                            @error('solution')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="commentaires" id="commentaires" rows="2" class="form-control @error('commentaires') is-invalid @enderror" placeholder="Commentaires...">{{ old('commentaires') }}</textarea>
                            @error('commentaires')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('clients.reclamations.index') }}" class="btn btn-secondary">
