...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form method="GET" action="{{ route('clients.integrations.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div>
                ...
                <select name="integration_type" id="integration_type" 
                    ...
                    <option value="crm" {{ request('integration_type') == 'crm' ? 'selected' : '' }}>CRM</option>
                    <option value="marketing" {{ request('integration_type') == 'marketing' ? 'selected' : '' }}>Marketing</option>
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('clients.integrations.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-primary-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-primary-700 uppercase tracking-wider">Système Externe</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-primary-700 uppercase tracking-wider">ID Externe</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-primary-700 uppercase tracking-wider">Statut</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-primary-700 uppercase tracking-wider">Dernière Synchronisation</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $integration->client->nom_raison_sociale }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('clients.integrations.edit', $integration) }}" class="text-red-600 hover:text-red-900 mr-3">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <form action="{{ route('clients.integrations.destroy', $integration) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
