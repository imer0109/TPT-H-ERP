...
@section('title', 'Nouvelle Intégration - Portail Fournisseur')

@section('header', 'Créer une nouvelle intégration')
...
<div class="rounded-lg bg-white p-6 shadow">
    <form action="{{ route('supplier.portal.integrations.store') }}" method="POST">
        @csrf
