...
@section('title', 'Détails du document - ' . $fournisseur->raison_sociale)
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">
                        Détails du document: {{ $document->nom }}
                    </h2>
                    <div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="font-semibold">{{ $document->nom }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-semibold">{{ $document->description ?? 'N/A' }}</p>
                            </div>
                            <div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="font-semibold">{{ $document->nom }}.{{ $document->extension }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Taille</p>
                                <p class="font-semibold">{{ number_format($document->taille / 1024, 2) }} KB</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Extension</p>
                                <p class="font-semibold">{{ strtoupper($document->extension) }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Date de téléchargement</p>
                                <p class="font-semibold">{{ $document->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Téléchargé par</p>
                                <p class="font-semibold">{{ $document->uploadedBy ? $document->uploadedBy->name : 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex space-x-4">
                    ...
                    @if(strtolower($document->extension) === 'pdf')
                        <a href="{{ route('fournisseurs.documents.view', [$fournisseur, $document]) }}" 
                           target="_blank"
