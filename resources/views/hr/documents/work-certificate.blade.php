...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <form action="{{ route('hr.documents.work-certificate.generate', $employee) }}" method="POST" id="workCertificateForm">
            @csrf
            <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900">{{ $employee->date_embauche ? $employee->date_embauche->format('d/m/Y') : 'N/A' }}</p>
                    </div>
                </div>
